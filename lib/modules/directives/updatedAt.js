  ...
  visitFieldDefinition(field) {
    (0, _utils.appendTransform)(field, _handlers.TRANSFORM_TO_INPUT, {
      [_kinds.CREATE]: ({
        ...
        name: field.name,
        type: field.type,
        mmTransformAlways: (0, _utils.reduceTransforms)([this._setDateCreate(field.name), (0, _transforms.fieldInputTransform)(field, _kinds.CREATE)])
      }],
      [_kinds.UPDATE]: ({
        field
      }) => [{
        name: field.name,
        type: field.type,
        mmTransformAlways: (0, _utils.reduceTransforms)([this._setDateUpdate(field.name), (0, _transforms.fieldInputTransform)(field, _kinds.UPDATE)])
      }]
    });
  }
