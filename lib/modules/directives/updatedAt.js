    ...
    value: function visitFieldDefinition(field) {
      ...
      (0, _utils.appendTransform)(field, _handlers.TRANSFORM_TO_INPUT, (_appendTransform = {}, (0, _defineProperty2.default)(_appendTransform, _kinds.CREATE, function (_ref) {
        ...
        return [{
          name: field.name,
          type: field.type,
          mmTransformAlways: (0, _utils.reduceTransforms)([_this._setDateCreate(field.name), (0, _transforms.fieldInputTransform)(field, _kinds.CREATE)])
        }];
        ...
        return [{
          name: field.name,
          type: field.type,
          mmTransformAlways: (0, _utils.reduceTransforms)([_this._setDateUpdate(field.name), (0, _transforms.fieldInputTransform)(field, _kinds.UPDATE)])
        }];
      }), _appendTransform));
    }
  }]);
