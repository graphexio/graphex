  ...
  visitFieldDefinition(field) {
    (0, _utils.appendTransform)(field, _handlers.TRANSFORM_TO_INPUT, {
      [_kinds.CREATE]: ({
        ...
        name: field.name,
        type: field.type,
        mmTransformAlways: (0, _utils.reduceTransforms)([(0, _transforms.fieldInputTransform)(field, _kinds.CREATE), this._setDate(field.name)])
      }],
      [_kinds.UPDATE]: ({
        field
      }) => [{
        name: field.name,
        type: field.type,
        mmTransformAlways: (0, _utils.reduceTransforms)([(0, _transforms.fieldInputTransform)(field, _kinds.UPDATE), this._setDate(field.name)])
      }]
    });
  }
