    ...
    value: function visitFieldDefinition(field) {
      ...
      (0, _utils.appendTransform)(field, _handlers.TRANSFORM_TO_INPUT, (0, _defineProperty2.default)({}, _kinds.CREATE, function (_ref) {
        ...
        return [{
          name: field.name,
          type: field.type,
          mmTransformAlways: (0, _utils.reduceTransforms)([//Must do the transforms first then fieldInputTransform so that default doesn't break things
          //Also you are dealing in raw document structure in here
          _this._setDateCreate(field.name), (0, _transforms.fieldInputTransform)(field, _kinds.CREATE)])
        }];
      }));
    }
  }]);
