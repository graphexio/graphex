...
var _timestamps = _interopRequireWildcard(require("./directives/timestamps"));
...
var ModelMongo = function ModelMongo(_ref) {
  ...
  (0, _defineProperty2.default)(this, "makeExecutableSchema", function (params) {
    ...
    typeDefs = [_initialScheme.default, _inherit.InheritScheme, _model.ModelScheme, _db.DirectiveDBScheme, _relation.RelationScheme, _timestamps.TimestampsScheme, _id.IDScheme, _unique.UniqueScheme, _extRelation.ExtRelationScheme].concat((0, _toConsumableArray2.default)(_scalars.typeDefs), (0, _toConsumableArray2.default)(typeDefs));
    schemaDirectives = (0, _objectSpread2.default)({}, schemaDirectives, {
      timestamps: _timestamps.default,
