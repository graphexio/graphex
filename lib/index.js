...
var _createdAt = _interopRequireWildcard(require("./directives/createdAt"));

var _updatedAt = _interopRequireWildcard(require("./directives/updatedAt"));

var _default = _interopRequireWildcard(require("./directives/default"));
...
var ModelMongo = function ModelMongo(_ref) {
  ...
  (0, _defineProperty2.default)(this, "_createAllQuery", function (modelType) {
    ...
    var whereType, orderByType;

    try {
      whereType = _this._inputType(modelType, KIND.WHERE);
      orderByType = _this._inputType(modelType, KIND.ORDER_BY);
    } catch (e) {
      return;
    }
  ...
  (0, _defineProperty2.default)(this, "_createConnectionQuery", function (modelType) {
    ...
    _this.Query._fields[name] = {
      ...
      resolve: function () {
        ...
        /*#__PURE__*/
        _regenerator.default.mark(function _callee4(parent, args, context) {
  ...
  (0, _defineProperty2.default)(this, "_createSingleQuery", function (modelType) {
    ...
    try {
      whereUniqueType = _this._inputType(modelType, KIND.WHERE_UNIQUE);
    } catch (e) {
      return;
    }
    ...
    _this.Query._fields[name] = {
      ...
      resolve: function () {
        ...
        /*#__PURE__*/
        _regenerator.default.mark(function _callee5(parent, args, context) {
          var selector, entries, _ref2, _ref3, selectorField, id;
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                ...
                case 2:
                  ...
                  entries = Object.entries(selector);
                  _ref2 = entries.length ? Object.entries(selector)[0] : ["_id"], _ref3 = (0, _slicedToArray2.default)(_ref2, 2), selectorField = _ref3[0], id = _ref3[1];
        ...
        function resolve(_x11, _x12, _x13) {
  ...
  (0, _defineProperty2.default)(this, "_createCreateMutation", function (modelType) {
    ...
    try {
      inputType = _this._inputType(modelType, KIND.CREATE);
      args = [{
          ...
          return _regenerator.default.wrap(function _callee6$(_context6) {
            while (1) {
              switch (_context6.prev = _context6.next) {
                case 0:
                  _context6.next = 2;
                  return (0, _utils2.applyAlwaysInputTransform)({
                    parent: parent,
                    context: context
                  })(modelType, args.data, KIND.CREATE_ALWAYS);
  ...
  (0, _defineProperty2.default)(this, "_createDeleteMutation", function (modelType) {
    ...
    _this.Mutation._fields[name] = {
      ...
      resolve: function () {
        ...
        /*#__PURE__*/
        _regenerator.default.mark(function _callee7(parent, args, context) {
          var selector;
        ...
        function resolve(_x17, _x18, _x19) {
  ...
  (0, _defineProperty2.default)(this, "_createUpdateMutation", function (modelType) {
    var typeWrap = new _typeWrap.default(modelType);
    var args;
    var whereType, updateType;

    try {
      whereType = _this._inputType(modelType, KIND.WHERE_UNIQUE);
      updateType = _this._inputType(modelType, KIND.UPDATE);
    } catch (e) {
      return;
    }
    ...
    _this.Mutation._fields[name] = {
      ...
      resolve: function () {
        ...
        /*#__PURE__*/
        _regenerator.default.mark(function _callee8(parent, args, context) {
          var data, _prepareUpdateDoc, doc, validations, arrayFilters, selector;
              ...
              switch (_context8.prev = _context8.next) {
                case 0:
                  ...
                  return (0, _utils2.applyAlwaysInputTransform)({
                    parent: parent,
                    context: context
                  })(modelType, args.data, KIND.UPDATE_ALWAYS);
                ...
                case 5:
                  data = _context8.sent;
                  _prepareUpdateDoc = (0, _utils.prepareUpdateDoc)(data), doc = _prepareUpdateDoc.doc, validations = _prepareUpdateDoc.validations, arrayFilters = _prepareUpdateDoc.arrayFilters;
        ...
        function resolve(_x20, _x21, _x22) {
  ...
  (0, _defineProperty2.default)(this, "makeExecutableSchema", function (params) {
    ...
    typeDefs = [_initialScheme.default, _inherit.InheritScheme, _model.ModelScheme, _db.DirectiveDBScheme, _relation.RelationScheme, _default.DefaultDirectiveScheme, _createdAt.CreatedAtScheme, _updatedAt.UpdatedAtScheme, _id.IDScheme, _unique.UniqueScheme, _extRelation.ExtRelationScheme].concat((0, _toConsumableArray2.default)(_scalars.typeDefs), (0, _toConsumableArray2.default)(typeDefs));
    schemaDirectives = (0, _objectSpread2.default)({}, schemaDirectives, {
      createdAt: _createdAt.default,
      updatedAt: _updatedAt.default,
    ...
    directiveResolvers = (0, _objectSpread2.default)({}, directiveResolvers, {
      ...
      createdAt: _createdAt.CreatedAtResolver,
      updatedAt: _updatedAt.UpdatedAtResolver
    });
