...
class ModelMongo {
  constructor({
    ...
    (0, _defineProperty2.default)(this, "_createAllQuery", modelType => {
      ...
      this.Query._fields[name] = {
        ...
        resolve: async (parent, args, context) => {
          ...
          let sort = await (0, _utils2.applyInputTransform)({
            parent,
            context
        ...
        resolve: async (parent, args, context) => {
          ...
          let selector = {
            $and: [await (0, _utils2.applyInputTransform)({
              parent,
              context
            })(args.where, whereType), validations]
          };
    ...
    (0, _defineProperty2.default)(this, "_onSchemaInit", type => {
      ...
      _lodash.default.values(type._fields).forEach(field => {
    ...
    (0, _defineProperty2.default)(this, "makeExecutableSchema", params => {
      ...
      typeDefs = [_initialScheme.default, _inherit.InheritScheme, _model.ModelScheme, _db.DirectiveDBScheme, _relation.RelationScheme, _id.IDScheme, _unique.UniqueScheme, _extRelation.ExtRelationScheme, ..._scalars.typeDefs, ...typeDefs];
      ...
      _lodash.default.values(SchemaTypes).forEach(type => {
