  ...
  (0, _defineProperty2.default)(this, "_createConnectionQuery", function (modelType) {
    ...
    _this.Query._fields[name] = {
      ...
      resolve: function () {
        ...
        /*#__PURE__*/
        _regenerator.default.mark(function _callee4(parent, args) {
    ...
    _this.Query._fields[name] = {
      ...
      resolve: function () {
        ...
        _regenerator.default.mark(function _callee5(parent, args, context) {
          var selector, _Object$entries$, selectorField, id;
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                ...
                case 2:
                  ...
                  _Object$entries$ = (0, _slicedToArray2.default)(Object.entries(selector)[0], 2), selectorField = _Object$entries$[0], id = _Object$entries$[1];
