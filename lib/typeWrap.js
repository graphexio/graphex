...
class TypeWrap {
  constructor(_type) {
    ...
    (0, _defineProperty2.default)(this, "isAbstract", () => Boolean(this._abstract));
    ...
    if (_type instanceof TypeWrap) {
      ...
      this._abstract = _type._abstract;
      return;
    }
    ...
    if (Array.isArray(_realType._interfaces) && _realType._interfaces.length > 0) {
      this._inherited = _lodash.default.head(_realType._interfaces);
    }

    this._abstract = _realType.mmAbstract;
