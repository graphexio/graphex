    ...
    function RelationDirective() {
          ...
          return _regenerator.default.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 33:
                  return _context3.abrupt("return", (0, _defineProperty2.default)({}, storeField, ids));
      ...
      function () {
        ...
        _regenerator.default.mark(function _callee8(_ref18) {
          var selector, context, relationField, _assertThisInitialize8, collection, storeField, mmInterfaceModifier;

          return _regenerator.default.wrap(function _callee8$(_context8) {
            while (1) {
              switch (_context8.prev = _context8.next) {
                case 0:
                  selector = _ref18.selector, context = _ref18.context;
                  relationField = _this.args.field;
      ...
      function () {
        ...
        _regenerator.default.mark(function _callee9(_ref20) {
          var doc, context, relationField, _assertThisInitialize9, collection, storeField, mmInterfaceModifier;

          return _regenerator.default.wrap(function _callee9$(_context9) {
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
                  doc = _ref20.doc, context = _ref20.context;
                  relationField = _this.args.field;
      ...
      function () {
        ...
        _regenerator.default.mark(function _callee10(_ref22) {
          var docs, context, relationField, _assertThisInitialize10, collection, storeField, mmInterfaceModifier;

          return _regenerator.default.wrap(function _callee10$(_context10) {
            while (1) {
              switch (_context10.prev = _context10.next) {
                case 0:
                  docs = _ref22.docs, context = _ref22.context;
                  relationField = _this.args.field;
