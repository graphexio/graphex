  ...
  return _temp = class RelationDirective extends _graphqlTools.SchemaDirectiveVisitor {
    constructor(..._args) {
      ...
      (0, _defineProperty2.default)(this, "_validateInput", (type, isMany) => params => {
        let input = _lodash.default.head(Object.values(params));
        ...
        if (!isMany) {
          ...
          if ((input.disconnect || input.delete) && _lodash.default.difference(Object.keys(input), ['delete', 'disconnect']).length > 0) {
      ...
      (0, _defineProperty2.default)(this, "_transformInputOne", async (params, resolverArgs) => {
        ...
        if (input.connect) {
          ...
          return {
            [storeField]: _lodash.default.head(ids)
          };
      ...
      (0, _defineProperty2.default)(this, "_resolveSingle", field => async (parent, args, context, info) => {
        ...
        let value = fieldTypeWrap.isAbstract() ? parent[storeField]['$id'] : parent[storeField];
        collection = fieldTypeWrap.isAbstract() ? parent[storeField]['$ref'] : collection;
        ...
        return queryExecutor({
          ...
          context
        }).then(res => _lodash.default.head(res));
      });
