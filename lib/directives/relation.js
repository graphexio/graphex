...
var _default = function _default(queryExecutor) {
  ...
  function (_SchemaDirectiveVisit) {
    ...
    function RelationDirective() {
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 6;
                        return (0, _utils2.applyInputTransform)(params, inputType);
      ...
      (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_transformToInputCreateUpdate", function (_ref3) {
        ...
        return [{
          name: field.name,
          type: type,
          mmTransform: (0, _utils2.reduceTransforms)([Transforms.log(1), _this._validateInput(type, fieldTypeWrap.isMany()), Transforms.applyNestedTransform(type), fieldTypeWrap.isMany() ? _this._transformInputMany : _this._transformInputOne, Transforms.log(2)]) // async params => {
      ...
      function () {
        ...
        _regenerator.default.mark(function _callee2(params) {
          var _assertThisInitialize2, storeField, input, selector, ids, doc, id;
      ...
      function () {
        ...
        _regenerator.default.mark(function _callee3(params) {
          var _assertThisInitialize3, storeField, input, ids, selector, delete_ids, _selector, docs, create_ids;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                ...
                case 15:
                  ...
                  ids = (0, _toConsumableArray2.default)(ids).concat((0, _toConsumableArray2.default)(delete_ids));
      ...
      (0, _defineProperty2.default)((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), "_onSchemaInit", function (_ref11) {
        ...
        return (
          ...
          function () {
            ...
            _regenerator.default.mark(function _callee4(parent, args, context, info) {
              var relationField, _assertThisInitialize4, collection, storeField, value, selector;
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      _assertThisInitialize4 = (0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), collection = _assertThisInitialize4.mmCollectionName, storeField = _assertThisInitialize4.mmStoreField;
        ...
        return (
          ...
          function () {
            ...
            _regenerator.default.mark(function _callee5(parent, args, context, info) {
              var relationField, _assertThisInitialize5, fieldTypeWrap, collection, storeField, whereType, value, selector, docs, docsIndex;
              ...
              return _regenerator.default.wrap(function _callee5$(_context5) {
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      relationField = _this.args.field;
                      _assertThisInitialize5 = (0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), fieldTypeWrap = _assertThisInitialize5.mmFieldTypeWrap, collection = _assertThisInitialize5.mmCollectionName, storeField = _assertThisInitialize5.mmStoreField;
                      whereType = _inputTypes.default.get(fieldTypeWrap.realType(), KIND.WHERE);
                      value = parent[storeField];
                    ...
                    case 6:
                      _context5.t0 = _objectSpread3.default;
                      _context5.t1 = {};
                      _context5.next = 10;
                    ...
                    case 10:
                      ...
                      _context5.t3 = (0, _defineProperty2.default)({}, relationField, {
                        $in: value
                      });
                    ...
                    case 15:
                      ...
                      return _context5.abrupt("return", value.map(function (item) {
                        return docsIndex[item];
                      }));
      ...
      function () {
        ...
        /*#__PURE__*/
        _regenerator.default.mark(function _callee7(_ref15) {
          var selector, relationField, _assertThisInitialize7, collection, storeField, mmInterfaceModifier;

          return _regenerator.default.wrap(function _callee7$(_context7) {
            while (1) {
              switch (_context7.prev = _context7.next) {
                case 0:
                  selector = _ref15.selector;
                  relationField = _this.args.field;
                  ...
                  selector = (0, _objectSpread3.default)({}, selector, mmInterfaceModifier);
      ...
      function () {
        ...
        /*#__PURE__*/
        _regenerator.default.mark(function _callee8(_ref17) {
      ...
      function () {
        ...
        /*#__PURE__*/
        _regenerator.default.mark(function _callee9(_ref19) {
            ...
            while (1) {
              switch (_context9.prev = _context9.next) {
                case 0:
                  ...
                  doc = (0, _objectSpread3.default)({}, doc, mmInterfaceModifier);
      ...
      function () {
        ...
        /*#__PURE__*/
        _regenerator.default.mark(function _callee10(_ref21) {
              ...
              switch (_context10.prev = _context10.next) {
                case 0:
                  ...
                  docs = docs.map(function (doc) {
                    return (0, _objectSpread3.default)({}, doc, mmInterfaceModifier);
                  });
    ...
    (0, _createClass2.default)(RelationDirective, [{
      ...
      value: function visitFieldDefinition(field, _ref23) {
        var _appendTransform;

        var objectType = _ref23.objectType;
        var SchemaTypes = this.schema._typeMap;
        var relationField = this.args.field;
        var fieldTypeWrap = new _typeWrap.default(field.type);

        if (!(0, _utils.getDirective)(fieldTypeWrap.realType(), 'model')) {
        ...
        this.mmFieldTypeWrap = fieldTypeWrap; // this.mmLastType = typeWrap.realType();
        // this.mmIsMany = fieldTypeWrap.isMany();

        this.mmStoreField = (0, _utils.getRelationFieldName)(fieldTypeWrap.realType().name, relationField, fieldTypeWrap.isMany());
...
var createInput = function createInput(_ref24) {
  var name = _ref24.name,
      initialType = _ref24.initialType,
      kind = _ref24.kind,
      inputTypes = _ref24.inputTypes;
  var fields = {};
