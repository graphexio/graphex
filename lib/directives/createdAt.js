...
var CreatedAtScheme = "directive @createdAt(name:String) on FIELD_DEFINITION";
...
function (_TimestampDirective) {
  ...
  (0, _createClass2.default)(CreatedAt, [{
    ...
    value: function visitFieldDefinition(field) {
      ...
      (0, _utils.appendTransform)(field, _handlers.TRANSFORM_INPUT, (0, _defineProperty2.default)({}, _kinds.CREATE, this._setDate(field.name, name)));
    }
  }]);
  return CreatedAt;
