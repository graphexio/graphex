...
function (_SchemaDirectiveVisit) {
  ...
  (0, _createClass2.default)(DirectiveDB, [{
    ...
    value: function visitFieldDefinition(field) {
      ...
      (0, _inputTypes.appendTransform)(field, _inputTypes.TRANSFORM_INPUT, (_appendTransform = {}, (0, _defineProperty2.default)(_appendTransform, _inputTypes.INPUT_ORDER_BY, this._renameTransform(field.name, name)), (0, _defineProperty2.default)(_appendTransform, _inputTypes.INPUT_CREATE, this._renameTransform(field.name, name)), (0, _defineProperty2.default)(_appendTransform, _inputTypes.INPUT_WHERE, this._renameTransform(field.name, name)), _appendTransform));
    }
  }]);
  return DirectiveDB;
