...
var ModelScheme = "directive @model(primaryKey:String=\"id\") on OBJECT | INTERFACE";
...
function (_SchemaDirectiveVisit) {
  ...
  (0, _createClass2.default)(Model, [{
    ...
    value: function visitObject(object) {
      object.mmCollectionName = object.name;
    }
  }, {
    key: "visitInterface",
    value: function visitInterface(iface) {
      iface.mmCollectionName = iface.name;
      ...
      _lodash.default.values(SchemaTypes).filter(function (type) {
        ...
        type.mmCollectionName = iface.name;
      });
    }
  }]);
  return Model;
