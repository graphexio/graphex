...
var UpdatedAtScheme = "directive @updatedAt on FIELD_DEFINITION";
...
function (_TimestampDirective) {
  ...
  (0, _createClass2.default)(UpdatedAt, [{
    ...
    value: function visitFieldDefinition(field) {
      ...
      field.mmTransformAlways = [_kinds.CREATE_ALWAYS, _kinds.UPDATE_ALWAYS];
      (0, _utils.appendTransform)(field, _handlers.TRANSFORM_INPUT, (_appendTransform = {}, (0, _defineProperty2.default)(_appendTransform, _kinds.CREATE_ALWAYS, this._setDateCreate(field.name)), (0, _defineProperty2.default)(_appendTransform, _kinds.UPDATE_ALWAYS, this._setDateUpdate(field.name)), _appendTransform));
    }
  }]);
  return UpdatedAt;
