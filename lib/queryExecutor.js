  ...
  return (
    ...
    function () {
      ...
      _regenerator.default.mark(function _callee(params) {
        var willGet, didGet, willCreate, didCreate, willUpdate, didUpdate, willDelete, didDelete, type, collectionName, doc, docs, selector, _params$options, options, _params$context, context, skip, limit, sort, _options$arrayFilters, arrayFilters, Collection, cursor, dataLoaderKey, dataLoader, _dataLoaderKey, _dataLoader, _cursor, _cursor2;

        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                willGet = hooks.willGet, didGet = hooks.didGet, willCreate = hooks.willCreate, didCreate = hooks.didCreate, willUpdate = hooks.willUpdate, didUpdate = hooks.didUpdate, willDelete = hooks.willDelete, didDelete = hooks.didDelete;
                ...
                _context.t0 = type;
                _context.next = _context.t0 === FIND ? 7 : _context.t0 === FIND_ONE ? 12 : _context.t0 === FIND_IDS ? 16 : _context.t0 === COUNT ? 22 : _context.t0 === DISTINCT ? 27 : _context.t0 === INSERT_ONE ? 32 : _context.t0 === INSERT_MANY ? 33 : _context.t0 === DELETE_ONE ? 34 : _context.t0 === UPDATE_ONE ? 35 : 36;
                break;
