...
function initGeoJSONPoint(field, _ref) {
  ...
  (0, _inputTypes.appendTransform)(field, _inputTypes.TRANSFORM_TO_INPUT, (_appendTransform = {}, (0, _defineProperty2.default)(_appendTransform, _inputTypes.INPUT_ORDER_BY, function (field) {
    ...
    return [{
      ...
      mmTransform: function mmTransform(params) {
        ...
        if (field[_inputTypes.TRANSFORM_INPUT] && field[_inputTypes.TRANSFORM_INPUT][_inputTypes.INPUT_WHERE]) {
          params = field[_inputTypes.TRANSFORM_INPUT][_inputTypes.INPUT_WHERE](params);
        }
