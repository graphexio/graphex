...
function prepareUpdateDoc(doc) {
  ...
  Object.keys(doc).forEach(path => {
    ...
    if (_lodash.default.isObject(value) && !value instanceof Date && !Array.isArray(value)) {
    ...
    if (Array.isArray(value) || value instanceof Date || !_lodash.default.isObject(value) || Object.keys(value).length > 0) {
      set[path] = value;
    }
  });
  let newDoc = {};
