...
const flattenNested = params => {
  let fieldKey = _lodash.default.head(Object.keys(params));
...
const validateAndTransformNestedInput = (type, isMany) => params => {
  let value = _lodash.default.head(Object.values(params));
  ...
  return _lodash.default.mapValues(params, value => _lodash.default.merge(...Object.values(value)));
};
...
const validateAndTransformInterfaceValue = type => value => {
  ...
  return _lodash.default.head(Object.values(value));
};
