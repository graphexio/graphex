...
var applyInputTransform = function applyInputTransform(context) {
  var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "_fields";
  return (
    /*#__PURE__*/
    function () {
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return Promise.all(value.map(function (val) {
                  return applyInputTransform(context, key)(val, type.ofType);
                }));
              ...
              case 6:
                ...
                return _context4.abrupt("return", applyInputTransform(context, key)(value, type.ofType));
                      ...
                      while (1) {
                        switch (_context3.prev = _context3.next) {
                          ...
                          case 20:
                            ...
                            _context3.t7 = key;
                            _context3.next = 25;
                            return applyInputTransform(context, key)(val, field.type);
