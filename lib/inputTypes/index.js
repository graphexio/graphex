...
var ModifierTypes = {
  'in': function _in(type) {
    return new _graphql.GraphQLList(type);
  },
  'not_in': function not_in(type) {
    return new _graphql.GraphQLList(type);
  },
  'not': null,
...
var InputTypesClass = function InputTypesClass(SchemaTypes) {
  ...
  (0, _defineProperty2.default)(this, "_defaultTransformToInputOrderBy", function (_ref) {
    ...
    return [{
      ...
      mmTransform: (0, _utils.reduceTransforms)([field.mmTransform ? field.mmTransform : function (params) {
        return params;
      }, Transforms.fieldInputTransform(field, KIND.ORDER_BY)])
    }, {
  ...
  (0, _defineProperty2.default)(this, "_createInputEnum", function (_ref5) {
    ...
    _lodash.default.values(initialType._fields).forEach(function (field) {
      ...
      values = [].concat((0, _toConsumableArray2.default)(values), (0, _toConsumableArray2.default)(transformFunc({
        field: field,
        kind: kind,
        inputTypes: _this2
      })));
          ...
          return _regenerator.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return (0, _utils.applyInputTransform)(context)(params.AND, manyType);
          ...
          return _regenerator.default.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.next = 2;
                  return (0, _utils.applyInputTransform)(context)(params.OR, manyType);
  ...
  (0, _defineProperty2.default)(this, "_fillInputObjectInterface", function (_ref9) {
    ...
    fieldsArr = fieldsArr.map(function (fieldType) {
      ...
      if ([KIND.CREATE, KIND.WHERE, KIND.UPDATE, KIND.WHERE_UNIQUE].includes(kind) && fieldType !== initialType && fieldType.mmDiscriminator && initialType.mmDiscriminatorField) {
        mmTransform = (0, _utils.reduceTransforms)([Transforms.applyNestedTransform(inputType), kind === KIND.UPDATE ? function (params) {
  ...
  (0, _defineProperty2.default)(this, "_createInputNestedObject", function (_ref10) {
    ...
    if ([KIND.CREATE_ONE_NESTED, KIND.CREATE_ONE_REQUIRED_NESTED, KIND.CREATE_MANY_NESTED, KIND.CREATE_MANY_REQUIRED_NESTED, KIND.UPDATE_ONE_NESTED, KIND.UPDATE_ONE_REQUIRED_NESTED, KIND.UPDATE_MANY_NESTED, KIND.UPDATE_MANY_REQUIRED_NESTED].includes(kind)) {
      ...
      fields.create = {
        name: 'create',
        type: type,
        mmTransform: (0, _utils.reduceTransforms)([Transforms.applyNestedTransform(type), [KIND.UPDATE_MANY_NESTED, KIND.UPDATE_MANY_REQUIRED_NESTED].includes(kind) ? function (params) {
          return _lodash.default.mapValues(params, function (val) {
            return {
              $mmPushAll: val
            };
    ...
    if ([KIND.UPDATE_ONE_NESTED, KIND.UPDATE_ONE_REQUIRED_NESTED].includes(kind)) {
      ...
      fields.update = {
        name: 'update',
        type: _type,
        mmTransform: (0, _utils.reduceTransforms)([Transforms.applyNestedTransform(_type), !isInterface ? function (params) {
          return {
    ...
    if ([KIND.UPDATE_MANY_NESTED, KIND.UPDATE_MANY_REQUIRED_NESTED].includes(kind)) {
      ...
      fields.updateMany = {
        name: 'updateMany',
        type: updateType,
        mmTransform: (0, _utils.reduceTransforms)([Transforms.applyNestedTransform(updateType), function (params) {
      ...
      fields.deleteMany = {
        name: 'deleteMany',
        type: whereType,
        mmTransform: (0, _utils.reduceTransforms)([Transforms.applyNestedTransform(whereType), function (params) {
          return _lodash.default.mapValues(params, function (val) {
            return {
              $mmPull: {
                $or: val
